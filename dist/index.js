...
function staticMethods(target) {
  ...
  target.prototype.globalShow = function(event) {
    if (this.mount) {
      var hasTarget =
        (event && event.detail && event.detail.target && true) || false; // Create a fake event, specific show will limit the type to `solid`
...
var bodyListener = function bodyListener(callback, options, e) {
  var _options$respectEffec = options.respectEffect,
    respectEffect =
      _options$respectEffec === void 0 ? false : _options$respectEffec,
    _options$customEvent = options.customEvent,
    customEvent =
      _options$customEvent === void 0 ? false : _options$customEvent;
  var id = this.props.id;
...
function getPosition(e, target, node, place, desiredPlace, effect, offset) {
  ...
  var defaultOffset = getDefaultPosition(
    effect,
    targetWidth,
    targetHeight,
    tipWidth,
...
var getDefaultPosition = function getDefaultPosition(
  effect,
  targetWidth,
  targetHeight,
  tipWidth,
...
function getDefaultPopupColors(type) {
  return defaultColors[type]
    ? _objectSpread2({}, defaultColors[type])
    : undefined;
}
...
function getPopupColors(customColors, type, hasBorder) {
  ...
  var arrowColor = customColors.arrow
    ? customColors.arrow
                                ...
                                (function(_React$Component) {
                                  ...
                                  function ReactTooltip(props) {
                                    ...
                                    _this = _possibleConstructorReturn(
                                      this,
                                      _getPrototypeOf(ReactTooltip).call(
                                        this,
                                        props
                                      )
                                    );
                                    _this.state = {
                                      ...
                                      disable: false,
                                      possibleCustomEvents:
                                        props.possibleCustomEvents || '',
                                      possibleCustomEventsOff:
                                        props.possibleCustomEventsOff || '',
                                      originTooltip: null,
                                      isMultiline: false
                                    };
                                  ...
                                  _createClass(
                                    ...
                                    [
                                      ...
                                      },
                                      {
                                        ...
                                        value: function injectStyles() {
                                          ...
                                          targetArray.forEach(function(target) {
                                            ...
                                            var head = parentNode.querySelector(
                                              'head'
                                            );
                                          ...
                                          if (domRoots.length) {
                                            ...
                                            domRoots
                                              .filter(function(item, idx, src) {
                                                return (
                                                  src.indexOf(item) === idx
                                                );
                                              })
                                        ...
                                        value: function getTargetArray(id) {
                                          ...
                                          if (!id) {
                                            ...
                                            var escaped = id
                                              .replace(/\\/g, '\\\\')
                                              .replace(/"/g, '\\"');
                                            selector = '[data-tip][data-for="'.concat(
                                              escaped,
                                              '"]'
                                            );
                                      ...
                                      },
                                      {
                                        ...
                                        value: function bindListener() {
                                          ...
                                          if (this.isBodyMode()) {
                                            ...
                                            targetArray.forEach(function(
                                              target
                                            ) {
                                              var isCaptureMode = _this3.isCapture(
                                                target
                                              );

                                              var effect = _this3.getEffect(
                                                target
                                              );

                                              if (
                                                _this3.isCustomEvent(target)
                                              ) {
                                                _this3.customBindListener(
                                                  target
                                                );
                                        ...
                                        value: function unbindListener() {
                                          ...
                                          if (this.isBodyMode()) {
                                            ...
                                            targetArray.forEach(function(
                                              ...
                                              _this4.unbindBasicListener(
                                                target
                                              );

                                              if (_this4.isCustomEvent(target))
                                                _this4.customUnbindListener(
                                                  target
                                                );
                                            });
                                          }
                                      ...
                                      },
                                      {
                                        ...
                                        value: function unbindBasicListener(
                                          target
                                        ) {
                                      ...
                                      },
                                      {
                                        ...
                                        value: function showTooltip(
                                          ...
                                          if (isGlobalCall) {
                                            ...
                                            var isMyElement = targetArray.some(
                                              function(ele) {
                                          ...
                                          var isMultiline =
                                            ...
                                            multiline ||
                                            false; // If it is focus event or called by ReactTooltip.show, switch to `solid` effect

                                          var switchToSolid =
                                            e instanceof window.FocusEvent ||
                                            isGlobalCall; // if it needs to skip adding hide listener to scroll
                                          ...
                                          var effect =
                                            (switchToSolid && 'solid') ||
                                            this.getEffect(e.currentTarget);
                                          var offset =
                                            e.currentTarget.getAttribute(
                                              'data-offset'
                                            ) ||
                                          ...
                                          var place = result.isNewState
                                            ? result.newState.place
                                            : desiredPlace; // To prevent previously created timers from triggering
                                                  ...
                                                  self.intervalUpdateContent = setInterval(
                                                    function() {
                                                      if (self.mount) {
                                                        ...
                                                        var isEmptyTip = self.isEmptyTip(
                                                          placeholder
                                                        );
                                                        self.setState({
                                      ...
                                      },
                                      {
                                        ...
                                        value: function hideTooltip(
                                          ...
                                          if (
                                            ...
                                            return; // if the tooltip is empty, disable the tooltip
                                      ...
                                      },
                                      {
                                        ...
                                        value: function updatePosition() {
                                          ...
                                          var _this$state2 = this.state,
                                            currentEvent =
                                              _this$state2.currentEvent,
                                            currentTarget =
                                              _this$state2.currentTarget,
                                            place = _this$state2.place,
                                            desiredPlace =
                                              _this$state2.desiredPlace,
                                          ...
                                          node.style.left =
                                            result.position.left + 'px';
                                          node.style.top =
                                            result.position.top + 'px';
                                        }
                                        /**
                                        ...
                                        value: function hasCustomColors() {
                                          ...
                                          return Boolean(
                                            Object.keys(
                                              ...
                                              return (
                                                color !== 'border' &&
                                                _this8.state.customColors[color]
                                              );
                                            }) ||
                                              (this.state.border &&
                                                this.state.customColors[
                                      ...
                                      },
                                      {
                                        ...
                                        value: function render() {
                                          ...
                                          var _this$state3 = this.state,
                                            extraClass =
                                              _this$state3.extraClass,
                                            html = _this$state3.html,
                                            ariaProps = _this$state3.ariaProps,
                                            disable = _this$state3.disable;
                                          var content = this.getTooltipContent();
                                          var isEmptyTip = this.isEmptyTip(
                                            content
                                          );
                                          ...
                                          var tooltipClass =
                                            ...
                                            (this.state.border
                                              ? ' border'
                                              : '') +
                                            ' place-'.concat(this.state.place) + // top, bottom, left, right
                                            ' type-'.concat(
                                          ...
                                          if (
                                            ReactTooltip.supportedWrappers.indexOf(
                                              Wrapper
                                            ) < 0
                                          ) {
                                            Wrapper =
                                              ReactTooltip.defaultProps.wrapper;
                                          }
                                    ...
                                    [
                                      {
                                        ...
                                        value: function getDerivedStateFromProps(
                                          ...
                                          var newAriaProps = parseAria(
                                            nextProps
                                          );
                                          var isChanged = Object.keys(
                                            newAriaProps
                                          ).some(function(props) {
                                            return (
                                              newAriaProps[props] !==
